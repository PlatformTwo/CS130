...
--
-- Host: localhost
-- Generation Time: Nov 03, 2016 at 08:31 AM
...
(1111, 'fdsafdasfas', 'fdasfadsfdsaf', 'fdsaffs1111df@ucla.edu', 'default.jpg', 'Sophomore', '2016-11-02', '2016-11-02', 'unverified', 'No'),
...
(11122233, 'fsadf', 'dddddddddddd', 'casdf@ucla.edu', 'default.jpg', 'Sophomore', '2016-11-02', '2016-11-02', 'unverified', 'No');
...
INSERT INTO `user_society` (`user_id`, `id`) VALUES
(0, 1);
...
--
-- Indexes for table `user_society`
--
...
--
ALTER TABLE `user_society`
  ADD CONSTRAINT `society_id` FOREIGN KEY (`id`) REFERENCES `societies` (`id`),
